...
M3 real migrations 0015/0016 and C1 migrations 0017/0018 are on `main`. C2 is merged and physically closed. S1 owns migrations 0019/0020/0021 on `feat/s1-e2ee-crypto-recovery`; source implementation and closure harnesses are complete at `c85fdb1`, but executed S1-J evidence remains open.
