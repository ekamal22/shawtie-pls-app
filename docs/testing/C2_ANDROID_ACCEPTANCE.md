...
PHYSICAL ACCEPTANCE COMPLETE. EVERY MANDATORY SCENARIO (1 THROUGH 31 AND 33 THROUGH 36; THERE IS NO SCENARIO 32) PASSED ON THE PHYSICAL REDMI NOTE 9S AT THE FINAL EXECUTABLE SHA `ecbb2e1877fbc8ee7bbeac0c15674a66683e8143`, WHERE `npm run test:c2:closure` ALSO PASSED WITH `C2_AUTOMATED_INTEGRATED_PASS reserved=0`. MARKERS: `C2_ANDROID_ACCEPTANCE_PASS` AND `C2_PHYSICAL_REDMINOTE9S_ACCEPTANCE_PASS`. THE FIRST AUTOMATED-ONLY CLOSURE PASSED EARLIER AT `94e0e9329e083cb3d9bcf4e3b13ad60d4af2e978`. EVIDENCE: `docs/testing/C2_ANDROID_ACCEPTANCE_EVIDENCE.md`.
