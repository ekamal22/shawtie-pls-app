...
| Message plaintext | HIGHLY_SENSITIVE | No after stable E2EE | Yes | Never | Never server plaintext backup | Never provider plaintext | User delete, final dissolution, permanent account deletion |
...
| Online presence | SENSITIVE | Transiently | Metadata | Avoid history logs | No long-term backup | Realtime infrastructure only | Immediate or short expiry |
