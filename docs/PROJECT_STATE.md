...
- UX2 through UX7: PLANNED product-experience implementation after UX1, with presentation-only work required to preserve existing API, database, lifecycle, messaging, and C1/C2 call semantics.
