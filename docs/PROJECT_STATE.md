...
5. C1 may implement in parallel with M3 using reservations, but final C1 closure waits for real M3 0015/0016 on main
6. keep C2 video separate and blocked until C1 is implemented, physically verified, and merged
