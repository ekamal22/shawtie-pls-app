...
- `feat/s1-e2ee-crypto-recovery` -> active S1 implementation branch; source implementation and closure harnesses complete at `0e28675`, S1-J execution evidence pending
