...
Implementation status: M2 realtime/offline closure is complete and merged. C1 source implementation adds an explicitly negotiated realtime v2 call invalidation without reopening M2 v1 semantics; C1 automated/local verification passed at `439b09f`, while mandatory physical Android acceptance and final M3-integrated closure remain open.
