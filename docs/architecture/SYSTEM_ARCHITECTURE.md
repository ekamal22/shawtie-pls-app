...
- current runtime keeps M3 media/voice references fail-closed; the design-complete M3 integration defines the future resolver, ready-media validation, and release-aware access path
