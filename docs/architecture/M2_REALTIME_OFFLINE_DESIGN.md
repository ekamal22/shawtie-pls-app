...
DESIGN COMPLETE, SECOND-PASS HARDENED. SOURCE IMPLEMENTATION, AUTOMATED/LOCAL VALIDATION, AND PHYSICAL DEVICE CLOSURE COMPLETE. M2 IS DONE AND FAST-FORWARD MERGED TO `main @ b6183158` FROM `feat/m2-realtime-offline`.
